 ...
 * @author: cnn
 * @createTime: 2021/12/15 11:11
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, WebGLRenderer, TorusKnotGeometry, MeshDepthMaterial as TMeshDepthMaterial, Mesh, PointLight, AmbientLight
} from 'three';
...
const MeshDepthMaterial = () => {
  ...
  const initCube = () => {
    ...
    const material = new TMeshDepthMaterial({
      depthTest: true,
      depthWrite: true,
    });

/**
 * @description: 二维三次贝塞尔曲线
 * 创建一条平滑的二维 三次贝塞尔曲线， 由起点、终点和两个控制点所定义。
 * @author: cnn
 * @createTime: 2022/1/27 14:32
 **/
import React, { useEffect, useState } from 'react';
import {
  BufferGeometry, Color, CubicBezierCurve as TCubicBezierCurve, Line, LineBasicMaterial,
...
const CubicBezierCurve = () => {
  ...
  // 生成曲线
  const initCurve = () => {
    const curve = new TCubicBezierCurve(
      new Vector2(-10, 0),
      new Vector2(-5, 15),
      new Vector2(20, 15),
      new Vector2(10, 0),

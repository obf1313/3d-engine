 ...
 * @author: cnn
 * @createTime: 2022/1/27 14:46
 **/
import React, { useEffect, useState } from 'react';
import {
  BufferGeometry, Color, EllipseCurve as TEllipseCurve, Line, LineBasicMaterial,
  WebGLRenderer
} from 'three';
...
const EllipseCurve = () => {
  ...
  // 生成曲线
  const initCurve = () => {
    const curve = new TEllipseCurve(0, 0, 10, 10, 0, 2 * Math.PI, false, 0);

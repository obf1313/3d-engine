 ...
 * @author: cnn
 * @createTime: 2022/1/23 14:42
 **/
import React, { useEffect, useState } from 'react';
import {
  BoxGeometry, Color, Mesh, MeshBasicMaterial, WebGLRenderer,
  TextureLoader as TTextureLoader, RepeatWrapping
} from 'three';
...
const TextureLoader = () => {
  ...
  const initCube = () => {
    ...
    // 初始化纹理
    const texture = new TTextureLoader().load(staticUrlPrefix + 'crate.gif');

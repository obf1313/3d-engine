/**
 * @description: 网格
 * 表示基于以三角形为 polygon mesh（多边形网格）的物体的类。
 * 同时也作为其他类的基类，例如 SkinnedMesh。
 * @author: cnn
 * @createTime: 2021/12/23 10:38
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, HemisphereLight, DirectionalLight, WebGLRenderer,
  BoxGeometry, Mesh as TMesh, MeshPhongMaterial
} from 'three';
...
const Mesh = () => {
  ...
  const initCube = () => {
    ...
    const material = new MeshPhongMaterial({ color: 0xcc20ff });

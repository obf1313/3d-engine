...
import {
  Color, WebGLRenderer, RingGeometry as TRingGeometry, MeshBasicMaterial, Mesh,
  DoubleSide
} from 'three';
...
const RingGeometry = () => {
  ...
  const animate = () => {
    ...
    if (ringGeometry) {
      ringGeometry.rotation.x += 0.01;
      ringGeometry.rotation.y += 0.01;
    }

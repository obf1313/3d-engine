...
import {
  Color, WebGLRenderer, TetrahedronGeometry as TTetrahedronGeometry, MeshBasicMaterial, Mesh,
  DoubleSide
} from 'three';
...
const TetrahedronGeometry = () => {
  ...
  // 生成一个 tetrahedronGeometry 放入场景中

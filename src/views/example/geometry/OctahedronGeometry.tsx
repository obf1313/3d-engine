 ...
 * 一个用于创建八面体的类。
 * @author: cnn
 * @createTime: 2021/11/17 16:37
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, WebGLRenderer, OctahedronGeometry as TOctahedronGeometry, MeshBasicMaterial, Mesh,
  DoubleSide
} from 'three';
...
const OctahedronGeometry = () => {
  ...
  // 生成一个 octahedronGeometry 放入场景中
  const initOctahedronGeometry = () => {
  ...
  const animate = () => {
    ...
    if (octahedronGeometry) {
      octahedronGeometry.rotation.x += 0.01;
      octahedronGeometry.rotation.y += 0.01;
    }

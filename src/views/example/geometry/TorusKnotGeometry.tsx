/**
 * @description: 圆环缓冲扭结几何体
 * @author: cnn
 * @createTime: 2021/11/18 9:20
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, WebGLRenderer, TorusKnotGeometry as TTorusKnotGeometry, MeshBasicMaterial, Mesh,
  DoubleSide
} from 'three';

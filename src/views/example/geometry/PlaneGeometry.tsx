 ...
 * 一个用于生成平面几何体的类。
 * @author: cnn
 * @createTime: 2021/11/17 17:18
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, WebGLRenderer, PlaneGeometry as TPlaneGeometry, MeshBasicMaterial, Mesh,
  DoubleSide
} from 'three';
...
const PlaneGeometry = () => {
  ...
  const animate = () => {
    ...
    if (planeGeometry) {
      planeGeometry.rotation.x += 0.01;
      planeGeometry.rotation.y += 0.01;
    }

 ...
 * 用于模拟平面 Plane 的辅助对象。
 * @author: cnn
 * @createTime: 2022/1/19 9:14
 **/
import React, { useEffect, useState } from 'react';
import { Color, Plane, PlaneHelper as TPlaneHelper, Vector3, WebGLRenderer } from 'three';
...
const PlaneHelper = () => {
  ...
  const initPlane = () => {
    ...
    const helper = new TPlaneHelper(plane, 20, 0x0000ff);

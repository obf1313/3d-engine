 ...
 * @author: cnn
 * @createTime: 2022/1/18 17:12
 **/
import React, { useEffect, useState } from 'react';
import { Color, GridHelper as TGridHelper, WebGLRenderer } from 'three';
...
const GridHelper = () => {
  ...
  const initGridHelper = () => {
    ...
    const gridHelper = new TGridHelper(size, divisions, 0xffffff, 0xffffff);

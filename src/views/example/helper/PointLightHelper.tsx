 ...
 * @author: cnn
 * @createTime: 2022/1/19 9:22
 **/
import React, { useEffect, useState } from 'react';
import { Color, PointLightHelper as TPointLightHelper, PointLight, WebGLRenderer } from 'three';
...
const PointLightHelper = () => {
  ...
  const initLight = () => {
    ...
    const sphereSize = 5;
    const pointLightHelper = new TPointLightHelper(pointLight, sphereSize);
    THREE_CONST.scene.add(pointLightHelper);
  };
  // 更新
  const animate = () => {

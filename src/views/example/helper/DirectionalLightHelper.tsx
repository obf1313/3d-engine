 ...
 * @author: cnn
 * @createTime: 2022/1/18 17:00
 **/
import React, { useEffect, useState } from 'react';
import { Color, DirectionalLightHelper as TDirectionalLightHelper, DirectionalLight, WebGLRenderer } from 'three';
...
const DirectionalLightHelper = () => {
  ...
  const initLight = () => {
    ...
    const helper = new TDirectionalLightHelper(light, 5);

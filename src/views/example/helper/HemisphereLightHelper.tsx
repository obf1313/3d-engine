/**
 * @description: 半球形光源辅助对象
 * 创建一个虚拟的球形网格 Mesh 的辅助对象来模拟 半球形光源 HemisphereLight。
 * @author: cnn
 * @createTime: 2022/1/18 17:24
 **/
import React, { useEffect, useState } from 'react';
import { Color, HemisphereLight, HemisphereLightHelper as THemisphereLightHelper, WebGLRenderer } from 'three';
...
const HemisphereLightHelper = () => {
  ...
  const initLight = () => {
    ...
    const helper = new THemisphereLightHelper(light, 5);

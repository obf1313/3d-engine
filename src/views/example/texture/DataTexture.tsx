 ...
 * @author: cnn
 * @createTime: 2021/12/21 9:29
 **/
import React, { useEffect, useState } from 'react';
import {
  Color, WebGLRenderer, BoxGeometry, MeshBasicMaterial, Mesh,
  DataTexture as TDataTexture, RGBFormat
} from 'three';
...
const DataTexture = () => {
  ...
  const initCube = () => {
    ...
    const color = new Color(0x558855);
    ...
    const texture = new TDataTexture(data, width, height, RGBFormat);
